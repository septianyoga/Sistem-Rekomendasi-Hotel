    ...
    <div class="main-content">
        ...
        <section id="iq-responsive" class="overview-block-ptb text-center iq-responsive-media ">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <img class="img-fluid center-block" src="images/drive/20.png" alt="">
                    </div>
                </div>
                        ...
                        <div class="screenshots-slider popup-gallery">
                            <div class="slider-container">
                                <div class="slider-content">
                                    ...
                                    <div class="slider-single">
                                        <a href="images/screenshot/01.jpg" class="popup-img"><img class="slider-single-image" src="images/screenshots/06.jpg" alt="6" /></a>
                                    </div>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="iq-accordion iq-mt-50">
                            <div class="iq-accordion-block iq-accordion-active"> <a href="javascript:void(0)" class="ad-title iq-tw-6 iq-font-grey">Ipsum is simply dummy the printing?</a>
                            ...
                            <div class="iq-accordion-block"> <a href="javascript:void(0)" class="ad-title iq-tw-6 iq-font-grey">Dummy the printing and type setting?</a>
                            ...
                            <div class="iq-accordion-block"> <a href="javascript:void(0)" class="ad-title iq-tw-6 iq-font-grey">Standard dummy since the 1500s?</a>
                                <div class="iq-accordion-details">
                                    <div class="row">
                                        <div class="col-sm-9"> It has survived not only five centuries, but also the leap into electronic typesetting. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur.</div>
                                        <div class="col-sm-3"><img alt="#" class="img-fluid" src="images/blog/01.jpg"></div>
                            ...
                            <div class="iq-accordion-block"> <a href="javascript:void(0)" class="ad-title iq-tw-6 iq-font-grey">It has survived five centuries?</a>
                                <div class="iq-accordion-details">It has survived not only five centuries, but also the leap into electronic typesetting. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.</div>
                            </div>
                        </div>
                    </div>
