...
<html lang="en">
    ...
    <body data-spy="scroll" data-offset="80">
        ...
        <!-- Header End -->
        <!-- Banner -->
        <section id="iq-home" class="iq-banner overview-block-pt iq-bg-over iq-over-blue-90 iq-parallax" data-jarallax='{"speed": 0.6}' style="background: url(images/bg/01.jpg);">
            <div class="container-fluid">
        ...
        <div class="main-content">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-lg-6">
                            ...
                            <ul class="iq-mt-40 iq-list">
                                ...
                                <li class="iq-tw-6"><i class="ion-android-done-all iq-mr-10 iq-font-blue iq-font-30"></i><span class="iq-font-black">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in aliquam lorem.</span></li>
                                <li class="iq-tw-6"><i class="ion-android-done-all iq-mr-10 iq-font-blue iq-font-30"></i><span class="iq-font-black">aliquet tortor id odio sollicitudin auctor. Maecenas sit amet molestie augue.</span></li>
                                <li class="iq-tw-6"><i class="ion-android-done-all iq-mr-10 iq-font-blue iq-font-30"></i><span class="iq-font-black">Donec iaculis mi dolor, in sodales quam condimentum eu. Nam tincidunt porttitor.</span></li>
                                <li class="iq-tw-6"><i class="ion-android-done-all iq-mr-10 iq-font-blue iq-font-30"></i><span class="iq-font-black">Aliquam rutrum est eget orci aliquet vulputate type setting industry.</span></li>
                            </ul>
                            <a href="javascript:void(0)" class="button iq-mt-10">View All</a>
                        </div>
                    </div>
                                ...
                                <div class="slider-container">
                                    <div class="slider-content">
                                        <div class="slider-single">
                                            <a href="images/screenshot/01.jpg" class="popup-img"><img class="slider-single-image" src="images/screenshot/01.jpg" alt="1" /></a>
                                        </div>
                                        <div class="slider-single">
                                            <a href="images/screenshot/01.jpg" class="popup-img"><img class="slider-single-image" src="images/screenshot/02.jpg" alt="2" /></a>
                                        </div>
                                        <div class="slider-single">
                                            <a href="images/screenshot/01.jpg" class="popup-img"><img class="slider-single-image" src="images/screenshot/03.jpg" alt="3" /></a>
                                        </div>
                                        <div class="slider-single">
                                            <a href="images/screenshot/01.jpg" class="popup-img"><img class="slider-single-image" src="images/screenshot/04.jpg" alt="4" /></a>
                                        </div>
                                        <div class="slider-single">
                                            <a href="images/screenshot/01.jpg" class="popup-img"><img class="slider-single-image" src="images/screenshot/05.jpg" alt="5" /></a>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-lg-4">
                            <div class="iq-pricing text-center">
                                <div class="price-title iq-parallax iq-over-blue-80" data-jarallax='{"speed": 0.6}' style="background: url(images/bg/02.jpg);">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-3 col-md-6">
                            <div class="iq-team grey-bg">
                                <div class="iq-team-img">
                                    <img src="images/team/small/011.jpg" class="img-fluid center-block" alt="#">
                                </div>
                        ...
                        <div class="col-sm-12 col-lg-3 col-md-6 r4-mt-30">
                            <div class="iq-team grey-bg">
                                <div class="iq-team-img">
                                    <img src="images/team/small/012.jpg" class="img-fluid center-block" alt="#">
                                </div>
                                <div class="iq-team-info text-center">
                        ...
                        <div class="col-sm-12 col-lg-3 col-md-6 r-mt-30">
                            <div class="iq-team grey-bg">
                                <div class="iq-team-img">
                                    <img src="images/team/small/013.jpg" class="img-fluid center-block" alt="#">
                                </div>
                                <div class="iq-team-info text-center">
                        ...
                        <div class="col-sm-12 col-lg-3 col-md-6 r-mt-30">
                            <div class="iq-team grey-bg">
                                <div class="iq-team-img">
                                    <img src="images/team/small/014.jpg" class="img-fluid center-block" alt="#">
                                </div>
                                <div class="iq-team-info text-center">
                            ...
                            <div class="iq-services-box text-left iq-font-white">
                                ...
                                <div class="services-content">
                                    ...
                                    <div class="iq-progress-bar">
                                        ...
                                        <div class="iq-progress-bar">
                                            <span data-percent="90" style="transition: width 2s ease 0s; width: 90%;"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="overview-block-ptb white-bg iq-asked">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="iq-accordion iq-mt-50">
                                <div class="iq-accordion-block iq-accordion-active"> <a href="javascript:void(0)" class="accordion-title iq-tw-6 iq-font-grey">Ipsum is simply dummy the printing?</a>
                            ...
                            <div class="iq-accordion-block"> <a href="javascript:void(0)" class="accordion-title iq-tw-6 iq-font-grey">Dummy the printing and type setting?</a>
                            <div class="iq-accordion-details">It has survived not only five centuries, but also the leap into electronic typesetting. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.</div>
                        </div>
                        <div class="iq-accordion-block"> <a href="javascript:void(0)" class="accordion-title iq-tw-6 iq-font-grey">Standard dummy since the 1500s?</a>
                        <div class="iq-accordion-details">
                            <div class="row">
                                <div class="col-sm-9"> It has survived not only five centuries, but also the leap into electronic typesetting. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur.</div>
                                <div class="col-sm-3"><img alt="#" class="img-fluid" src="images/blog/01.jpg"></div>
                    ...
                    <div class="iq-accordion-block"> <a href="javascript:void(0)" class="accordion-title iq-tw-6 iq-font-grey">It has survived five centuries?</a>
                    <div class="iq-accordion-details">It has survived not only five centuries, but also the leap into electronic typesetting. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.</div>
                </div>
            </div>
        </div>
...
<!-- back-to-top -->
<div id="back-to-top">
<a class="top" id="top" href="#top"> <i class="ion-ios-uploaccordion-outline"></i> </a>
</div>
<!-- back-to-top End -->
<!-- style-customizer -->
